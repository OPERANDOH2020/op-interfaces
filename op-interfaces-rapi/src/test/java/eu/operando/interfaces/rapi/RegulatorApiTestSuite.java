...
import eu.operando.interfaces.rapi.impl.ComplianceReportsServiceImplTests;
import eu.operando.interfaces.rapi.impl.RegulationsApiServiceImplTests;
...
({
	...
	ComplianceReportsServiceImplTests.class,
